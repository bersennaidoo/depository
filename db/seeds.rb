...
# encoding: utf-8
Product.delete_all
Product.create!(title: 'Docker for Developers',
  description:
    %{<p>
      <em>Build, Ship, and Run Your Applications Everywhere</em> Docker does
      great things for devOps it  gives you a new set
  ...
  price: 19.95)
# . . .
Product.create!(title: 'Design and Build with OpenApi',
  description:
    %{<p>
  ...
  image_url: 'openapi.jpg',
  price: 24.95)
# . . .

Product.create!(title: 'Css with Tailwind',
  description:
    %{<p>
